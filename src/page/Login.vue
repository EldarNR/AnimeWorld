        ...
        <v-card class="mx-auto px-6 py-8" max-width="344">
            ...
            <form class="form mt-3">
                ...
                <div class="inputForm">
                    ...
                    <input placeholder="Enter your Email" autocomplete="email" v-model="inputEmail" class="input"
                        type="text">
                </div>
                ...
                <div class="inputForm">
                    ...
                    <input current-password autocomplete="password" v-model="inputPassword"
                ...
                <v-btn class="button-submit" @click="goToPage">Sign In</v-btn>
...
export default {
    ...
    methods: {
        goToPage() {
            if (this.inputEmail === "Demo" && this.inputPassword === "Demo") {
                this.$router.push({ name: "Home" });
                store.dispatch("getAccountInfo", true);
            } else {
                this.alert = true;
                console.error("Error: Email or password incorrect");
                setTimeout(() => {
                    this.alert = false;
                }, 2000);
            }
